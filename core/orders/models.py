...
class OrderItem(models.Model):
    ...
    final_cup = models.ForeignKey(
        FinalCup, null=True, blank=True, on_delete=models.SET_NULL
    )
    custom_cup = models.ForeignKey(
        CustomCup, null=True, blank=True, on_delete=models.SET_NULL
    )
